...
class TestT07DEFAULTCALCactiontag():
  ...
  def test_t07DEFAULTCALCactiontag(self):
    ...
    elements = self.driver.find_elements(By.CSS_SELECTOR, "input[name=\"tagdefaultcalc\"][value=\"25\"]")
    assert len(elements) > 0
